...
(function (factory) {
    ...
    var Utils = {
        ...
        insert_css_rule: function (sheet, selector, rules, index) {
        	...
        	//alert(selector+" /n "+rules+" /n "+index);
    ...
    GridStackEngine.prototype._sort_nodes = function (dir) {
    	//alert("_sort_nodes:"+this.nodes+" "+dir + " " +this.width);
    ...
    var GridStack = function (el, opts) {
        ...
        this.grid = new GridStackEngine(this.opts.width, function (nodes) {
            ...
            self._update_styles(max_height + 5);
            //alert("GridStackEngine");
    ...
    GridStack.prototype._update_styles = function (max_height) {
        ...
        //alert(max_height+"_styles"+this._styles._max+"prefix"+prefix);
        ...
        if (max_height > this._styles._max) {
            for (var i = this._styles._max; i < max_height; ++i) {
                ...
                css_custom += " /n "+prefix + '[data-gs-height="' + (i + 1) + '"]' +"----"+'height: ' + (this.opts.cell_height * (i + 1) + this.opts.vertical_margin * i) + 'px;';
                css_custom += " /n "+prefix + '[data-gs-min-height="' + (i + 1) + '"]' +"----"+'min-height: ' + (this.opts.cell_height * (i + 1) + this.opts.vertical_margin * i) + 'px;';
                css_custom += " /n "+prefix + '[data-gs-max-height="' + (i + 1) + '"]' +"----"+'max-height: ' + (this.opts.cell_height * (i + 1) + this.opts.vertical_margin * i) + 'px;';
                css_custom += " /n "+prefix + '[data-gs-y="' + (i + 1) + '"]' +"----"+'top: ' + (this.opts.cell_height * i + this.opts.vertical_margin * i) + 'px;';
                
            }
            this._styles._max = max_height;
            
            //最终数据
            //alert("所有的布局："+css_custom);
    ...
    GridStack.prototype._prepare_element = function (el) {
        ...
        //alert("GridStack.prototype._prepare_element");
        ...
        el.draggable(_.extend(this.opts.draggable, {
            ...
            resize: function (event, ui) {
                ...
                //alert("resizable on_end_moving end.....");
            }
        }));
