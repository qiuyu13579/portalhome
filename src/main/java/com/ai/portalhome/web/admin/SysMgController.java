...
public class SysMgController extends AppBaseController{
...
//			model.addAttribute("pageInfo", page );
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/menu/getData")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/menu/getDataHis")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/menu/showAdd")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/menu/queryMenuList")
	@ResponseBody
