...
public class LoMainInfo extends BaseVO{
    ...
    private List<LoMainInfo> listMain;
    
    private List<TLoColumn> listColumn;
	...
	public List<TLoColumn> getListColumn() {
		return listColumn;
	}

	public void setListColumn(List<TLoColumn> listColumn) {
	...
	public List<LoMainInfo> getListMain() {
		return listMain;
	}

	public void setListMain(List<LoMainInfo> listMain) {
